...
namespace ZXing.Net.Mobile.Forms
{
    public class ZXingScannerPage : ContentPage
    {
        ...
        public ZXingScannerPage (MobileBarcodeScanningOptions options = null, View customOverlay = null) : base ()
        {
            ...
            zxing.SetBinding(ZXingScannerView.IsViewVisibleProperty, new Binding(nameof(IsViewVisible)));
        ...
        public static readonly BindableProperty IsViewVisibleProperty =
       BindableProperty.Create(nameof(IsViewVisible), typeof(bool), typeof(ZXingScannerPage), false);
