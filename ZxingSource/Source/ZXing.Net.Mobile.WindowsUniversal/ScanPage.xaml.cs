...
namespace ZXing.Mobile
{
    ...
    public sealed partial class ScanPage : Page
    {
        ...
        ZXingScannerControl scannerControl;
        //private static ScanPage scanpopUpPage = null;



        ///// <summary>
        /////  get PopUp Page Instance
        ///// </summary>
        ///// <returns></returns>
        //public static ScanPage getscanPopUpPageInstance()
        //{
        //    if (scanpopUpPage == null)
        //    {
        //        return new ScanPage();
        //    }
        //    else
        //        return scanpopUpPage;
        //}
        ...
        public ScanPage()
        {
            ...
            scannerControl = new ZXingScannerControl();
            this.Loading += ScanPage_Loading;
            this.Unloaded += ScanPage_Unloaded;
            //scannerControl = ZXingScannerControl.getPopUpPageInstance();
            PageGrid.Children.Add(scannerControl);
        }
        ...
        private void ScanPage_Loading(FrameworkElement sender, object args)
        {
#if WINDOWS_UWP
        ...
        public static event Action OnRequestResumeScan;
        ...
        public static void RequestResumeScan()
        {
            var evt = OnRequestResumeScan;
            if (evt != null)
                evt();
        }
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            OnRequestResumeScan += RequestResumeScanHandler;
